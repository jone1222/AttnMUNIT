...
while True:
    for it, (images_a, images_b) in enumerate(zip(train_loader_a, train_loader_b)):
        ...
        if (iterations + 1) % config['image_save_iter'] == 0:
            ...
            # trainer.visualize_attention_map(images_a,images_b)

            write_2images(test_image_outputs[:8], display_size, image_directory, 'test_%08d' % (iterations + 1))
            write_2images(train_image_outputs[:8], display_size, image_directory, 'train_%08d' % (iterations + 1))
        ...
        if (iterations + 1) % config['image_display_iter'] == 0:
            ...
            write_2images(image_outputs[:8], display_size, image_directory, 'train_current')
